    ...
    if request.method == 'POST':
                try:
                    ...
                    if not os.path.exists(save_directory):
                        ...
                        # because if we will hity the same url again and again, google will think we are fake user and it will block us. to prevent that blocking, we have written below code 
